...
pages_dir = base_dir / f"KW{KW}_V4_edit_ready" / "pages"
label_dir = base_dir / f"KW{KW}_V4_edit_ready" / "labels_abs"

# 🟢 neuer Outputpfad:
out_dir   = base_dir / f"KW{KW}_V6" / "matched"
...
KW = 42
base_dir = Path(r"C:\Users\pfudi\PycharmProjects\PythonProject\outputs\Run2") / f"KW{KW}_V6" / "matched"
